...
import { CohortComponent } from './component/cohort/cohort.component';
...
export const routingComponent = [IndexComponent,StudentComponent,CohortComponent,FacultyComponent,
